      ...
      <div className="grid gap-6 lg:grid-cols-[240px_1fr]">
        ...
        <nav className="space-y-1" aria-label="Settings navigation">
          {[
            ...
            <button
              key={label}
              className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-slate-400 transition hover:bg-surface-overlay hover:text-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/60"
            >
